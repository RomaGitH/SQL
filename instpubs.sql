...
if exists (select * from sysdatabases where name='pubs2')
begin
...
raiserror('Creating pubs2 database....',0,1)
go
/*
...
if db_name() <> 'pubs2'
   raiserror('Error in InstPubs.SQL, ''USE pubs2'' failed!  Killing the SPID now.'
            ,22,127) with log

GO

execute sp_dboption 'pubs2' ,'trunc. log on chkpt.' ,'true'
GO
